...
CHECK:          sub $a0, $a0, 1              #decrement the string pointer
...
LESS:           sub $t2, $t2, 1              #decrement string length count
                sub $a0, $a0, 1              #decrement string pointer
                lb $t4, ($a0)                #load character into $t4
                                                   
SPACE:          bne $t4, 32, EXIT            #if the character in $t4 is not a space jump to EXIT
                addiu $t9, $t9, 1            #otherwise increment value in $t9
                sub $t2, $t2, 1              #and decrement string length count
